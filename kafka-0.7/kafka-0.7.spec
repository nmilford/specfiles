...
Source0: %{kafka_name}-%{kafka_version}-incubating-src.tar.gz
...
./sbt update
./sbt package
sed -i 's,log.dir=/tmp/kafka-logs,log.dir=/var/log/kafka,g' ./config/server.properties
...
install    -m 644 %{_builddir}/%{kafka_name}-%{kafka_version}-incubating-src/CHANGES.txt      %{buildroot}/%{kafka_home}/
install    -m 644 %{_builddir}/%{kafka_name}-%{kafka_version}-incubating-src/DISCLAIMER       %{buildroot}/%{kafka_home}/
install    -m 644 %{_builddir}/%{kafka_name}-%{kafka_version}-incubating-src/LICENSE          %{buildroot}/%{kafka_home}/
install    -m 644 %{_builddir}/%{kafka_name}-%{kafka_version}-incubating-src/NOTICE           %{buildroot}/%{kafka_home}/
install    -m 644 %{_builddir}/%{kafka_name}-%{kafka_version}-incubating-src/README.md        %{buildroot}/%{kafka_home}/

install -d -m 755 %{buildroot}/%{kafka_home}/bin/
install    -m 644 %{_builddir}/%{kafka_name}-%{kafka_version}-incubating-src/bin/*.properties %{buildroot}/%{kafka_home}/bin
install    -m 755 %{_builddir}/%{kafka_name}-%{kafka_version}-incubating-src/bin/*.sh         %{buildroot}/%{kafka_home}/bin

install -d -m 755 %{buildroot}/%{kafka_home}/config/
install    -m 644 %{_builddir}/%{kafka_name}-%{kafka_version}-incubating-src/config/*         %{buildroot}/%{kafka_home}/config

install -d -m 755 %{buildroot}/%{kafka_home}/core/
install -d -m 755 %{buildroot}/%{kafka_home}/core/lib/
install    -m 644 %{_builddir}/%{kafka_name}-%{kafka_version}-incubating-src/core/lib/*       %{buildroot}/%{kafka_home}/core/lib
...
install    -m 644 %{_builddir}/%{kafka_name}-%{kafka_version}-incubating-src/core/lib_managed/scala_2.8.0/compile/*  %{buildroot}/%{kafka_home}/core/lib_managed/scala_2.8.0/compile/
install    -m 644 %{_builddir}/%{kafka_name}-%{kafka_version}-incubating-src/core/lib_managed/scala_2.8.0/test/*     %{buildroot}/%{kafka_home}/core/lib_managed/scala_2.8.0/test/

install -d -m 755 %{buildroot}/%{kafka_home}/core/target/
install -d -m 755 %{buildroot}/%{kafka_home}/core/target/scala_2.8.0/
install    -m 644 %{_builddir}/%{kafka_name}-%{kafka_version}-incubating-src/core/target/scala_2.8.0/kafka-0.7.0.jar %{buildroot}/%{kafka_home}/core/target/scala_2.8.0/

install -d -m 755 %{buildroot}/%{kafka_home}/project/
install    -m 644 %{_builddir}/%{kafka_name}-%{kafka_version}-incubating-src/project/build.properties  %{buildroot}/%{kafka_home}/project/build.properties
...
install    -m 644 %{_builddir}/%{kafka_name}-%{kafka_version}-incubating-src/project/boot/scala-2.8.0/lib/* %{buildroot}/%{kafka_home}/project/boot/scala-2.8.0/lib/
